...
export const CircleLoader = (props) => {
  return (
    <svg version="1.1" {...props} id="L1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
